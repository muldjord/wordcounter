...
{
  setWindowTitle(tr("About Wordcounter"));
  ...
  if(file.open(QIODevice::ReadOnly)) {
    ...
    printf("ERROR: Couldn't find COPYING file at the expected location.\n");
  ...
  title->setText(tr("<h1>Wordcounter</h1>"
                    "<h2>Version " VERSION "</h2>"
                    "Copyright (C) 2021 Lars Bisballe Jensen<br />"
                    "Wordcounter is free software released under the terms "
